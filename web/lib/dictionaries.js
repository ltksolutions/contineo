  ...
  sk: {
    ...
    tech: {
      ...
      pillars: [
        ...
        { icon: "shield", title: "Multi-tenant a bezpečnosť", text: "Hierarchia zväzov (SFZ → regionálny → oblastný) ako samostatné organizácie. Verejné normy vidia všetci; interný obsah len príslušníci daného zväzu. Audit pri každej zmene znalostí." },
        { icon: "layers", title: "Vstupné kanály (obsah aj integrácie)", text: "Jedna vrstva, ktorou tečie obsah: PDF normy, FAQ, weby (RSS), interné predpisy, MCP konektory (Drive, SharePoint, Confluence…) aj e-mail (IMAP) — zjednotené do jedného indexu. Sportnet.online je tu zdroj identity, nie obsahu." },
      ...
      stack: [
        ...
        "Integrácie: e-mail (IMAP), Sportnet.online (identita/CRM), MCP konektory",
      ],
      ...
      integrations: [
        ...
        { title: "Sportnet.online (identita a CRM)", text: "Prihlásenie cez sportnet.online (OAuth) a CRM ako zdroj pravdy o osobách a zväzoch: používatelia sa zakladajú automaticky, roly a skupiny podľa príslušnosti k zväzu/klubu (cez mapovaciu tabuľku alebo ručne). Contineo má vlastnú databázu, nezapisuje späť." },
      ...
      security: [
        "Prístup podľa príslušnosti k zväzu/klubu a skupín (automaticky zo sportnet.online); kto smie nahrávať obsah, sa povoľuje ručne. Audit pri každej zmene znalostí.",
        "Prihlásenie cez SSO: sportnet.online, Microsoft Entra ID, Google Workspace; verejný obsah aj bez prihlásenia.",
        ...
        "Multi-tenant hierarchia (SFZ → regionálny → oblastný): verejné normy vidia všetci, interný obsah je oddelený per organizácia.",
  ...
  en: {
    ...
    tech: {
      ...
      pillars: [
        ...
        { icon: "shield", title: "Multi-tenant and security", text: "A hierarchy of associations (SFZ → regional → district) as separate organisations. Public rules are visible to everyone; internal content only to members of that association. Audit trail on every knowledge change." },
        { icon: "layers", title: "Input channels (content & integrations)", text: "One layer through which content flows: PDF regulations, FAQs, websites (RSS), internal guidelines, MCP connectors (Drive, SharePoint, Confluence…) and e-mail (IMAP) — unified into one index. Sportnet.online here is a source of identity, not content." },
      ...
      stack: [
        ...
        "Claude API claude-sonnet-4-6 (fallback)",
        "Next.js 14 (App Router) · Node.js worker",
        "Integrations: e-mail (IMAP), Sportnet.online (identity/CRM), MCP connectors",
      ],
      ...
      integrations: [
        ...
        { title: "Sportnet.online (identity & CRM)", text: "Login via sportnet.online (OAuth) and CRM as the source of truth about people and associations: users are created automatically, roles and groups follow membership in an association/club (via a mapping table or manually). Contineo has its own database and doesn't write back." },
      ...
      security: [
        "Access by membership in an association/club and groups (automatically from sportnet.online); who may upload content is allow-listed manually. Audit trail on every knowledge change.",
        "SSO login: sportnet.online, Microsoft Entra ID, Google Workspace; public content also without login.",
        ...
        "Multi-tenant hierarchy (SFZ → regional → district): public rules visible to all, internal content isolated per organisation.",
