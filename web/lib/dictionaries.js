  ...
  sk: {
    ...
    tech: {
      ...
      flows: [
        ...
        { title: "Kontrola kvality a kurácia", text: "Nie strojové učenie, ale ľudská kurácia: schválené odpovede z ContineoLearning aj z upravených e-mailových odpovedí sa uložia ako overené odpovede a embedujú späť do znalostí. Overená odpoveď nikdy potichu neprepíše schválený predpis." },
      ],
  ...
  cs: {
    ...
    tech: {
      ...
      flows: [
        ...
        { title: "Kontrola kvality a kurace", text: "Ne strojové učení, ale lidská kurace: schválené odpovědi z ContineoLearning i z upravených e-mailových odpovědí se uloží jako ověřené odpovědi a naembedují zpět do znalostí. Ověřená odpověď nikdy potichu nepřepíše schválený předpis." },
      ],
  ...
  en: {
    ...
    tech: {
      ...
      flows: [
        ...
        { title: "Quality control & curation", text: "Not machine learning but human curation: approved answers from ContineoLearning and edited e-mail replies are stored as verified answers and embedded back into the knowledge base. A verified answer never silently overrides an approved document." },
      ],
