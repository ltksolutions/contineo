...
const SUITY = ["streams.test.ts", "profile.test.ts", "guard.test.ts", "httpAdapters.test.ts", "utility.test.ts", "residency.test.ts", "bedrock.test.ts", "sseKlient.test.ts", "formatText.test.ts", "cennik.test.ts"];
