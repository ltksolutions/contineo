...
- [ ] **`ContineoMark` pri 16 px vyzerá ako lupa** — kružnica s dvoma bodkami a trojuholníkovým chvostíkom („hlava s bublinou reči") funguje pri 26 px; pri 16 px je z nej krúžok s rúčkou, teda silueta lupy, a bodky splynú s odleskom skla. Kód je pritom podľa zadania (`KNIZNICA.md` úloha 3, `NASADENIE` PR 3) — chyba je v kresbe, nie na obrazovke. Prekresliť variant pre malé veľkosti: hrubší ťah, väčšie bodky, kratší chvostík. Dotkne sa šiestich miest (knižnica, hlavička, adresár, osoby, pätička, menu), preto samostatný PR a porovnanie oboch veľkostí vedľa seba pred nasadením. Rozhodnutie Jána 2026-09-22.
