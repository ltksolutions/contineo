...
| **O14** 🟡 | ~~Má sa merať čas strávený nad dokumentom?~~ **Rozhodnuté 2026-09-06 (Ján Letko): áno, merať.** Čas je **informatívny a nemá následok** — pri spolutvorcovi dokumentu bude krátky oprávnene, pri novom človeku je to silný signál. Žiadne pravidlo sa naň neviaže; keby sa naviazalo, patrí do smernice, nie do kódu. **Otvorené zostáva trojo:** človeku sa musí povedať, že sa to meria (veta na potvrdzovacej obrazovke, nie mlčky); údaj potrebuje vlastnú retenciu, kratšiu než potvrdenie, ktoré musí prežiť; a meria sa na klientovi, takže je orientačný a **nesmie sa použiť ako dôkaz** — kto nechá kartu otvorenú, má hodinu. Doskrolovanie na koniec sa nemeria. |
